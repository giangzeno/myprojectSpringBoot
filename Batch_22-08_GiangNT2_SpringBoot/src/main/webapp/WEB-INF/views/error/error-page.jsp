...
<body class="permission_denied">
	...
	<div class="denied__wrapper">
		<h1>${errorCode}</h1>
		<h3>${errorMsg}</h3>
		<svg id="astronaut" xmlns="http://www.w3.org/2000/svg"
			viewBox="0 0 512 512">
        <style>
.st0 {
	fill: none;
...
.st20 {
	fill: #53515B;
        ...
        <path
				...
				class="st1" />
<path d="M122 339.8h42.9c6.4 0 6.4-10 0-10H122c-6.4 0-6.4 10 0 10z"
				class="st1" />
        <path
...
<path
		...
		<svg id="planet" xmlns="http://www.w3.org/2000/svg"
			viewBox="0 0 512 512">
        <circle class="saturn" cx="256" cy="256" r="149.536"
				fill="#FF4F54" />
        ...
        <circle class="hover" cx="319.166" cy="208.081" r="28.389"
				fill="#D83A4E" />
        <path
				...
				opacity=".1" />
        <circle class="hover" cx="234.463" cy="273.978" r="19.358"
				fill="#D83A4E" />
        <path
				...
				opacity=".1" />
        <circle class="hover" cx="307.493" cy="144.207" r="12.584"
				fill="#D83A4E" />
        <path
				...
				opacity=".1" />
        <circle class="hover" cx="163.289" cy="255.495" r="19.358"
				fill="#D83A4E" />
        <path
...
<circle class="hover" cx="230.586" cy="365.92" r="19.358" fill="#D83A4E" />
        <path
				...
				opacity=".1" />
        <circle class="hover" cx="302.221" cy="353.781" r="19.357"
				fill="#D83A4E" />
        <path
				...
				opacity=".1" />
        <circle class="hover" cx="358.827" cy="284.847" r="11.079"
				fill="#D83A4E" />
        <path
				...
				opacity=".1" />
        <circle class="hover" cx="220.465" cy="156.416" r="11.079"
				fill="#D83A4E" />
        <path
				...
				opacity=".1" />
        <circle class="hover" cx="154.027" cy="171.743" r="5.819"
				fill="#D83A4E" />
        <path
				...
				opacity=".1" />
        <circle class="hover" cx="391.387" cy="251.305" r="5.819"
				fill="#D83A4E" />
        <path
				...
				opacity=".1" />
        <circle class="hover" cx="145.077" cy="302.473" r="5.819"
				fill="#D83A4E" />
        <path
				...
				opacity=".1" />
        <circle class="hover" cx="187.342" cy="355.265" r="5.819"
				fill="#D83A4E" />
        <path
		...
		<a href="${pageContext.request.contextPath}/Movie/Add"><button
				class="denied__link">Go Home</button></a>
	</div>
